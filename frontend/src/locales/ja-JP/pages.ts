export default {
  ...
  // Landing Page
  'pages.landing.title': '素晴らしいSaaSを',
  'pages.landing.subtitle': '記録的な速さで構築',
  'pages.landing.description': '最新のReact、FastAPI、PostgreSQLで構築された強力で安全、スケーラブルなSaaSプラットフォームテンプレート。',
  'pages.landing.getStarted': '無料で開始',
  'pages.landing.signIn': 'サインイン',
  'pages.landing.features.title': '成功に必要なすべてを',
  'pages.landing.features.description': 'プロダクションレディなコンポーネントと機能で、すぐに開発を開始できます。',
  'pages.landing.cta.title': '今すぐ構築を開始',
  'pages.landing.cta.description': '数分でアプリケーションを立ち上げ、何ヶ月もの開発時間を節約しましょう。',
  'pages.landing.cta.trial': '無料トライアル開始',
  'pages.landing.cta.demo': 'デモを見る',
  'pages.welcome.link': 'ようこそ',
  'pages.welcome.alertMessage': 'より高速で強力で頑丈なコンポーネントがリリースされました。',
